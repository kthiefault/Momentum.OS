...
const CRMPipeline = () => {
  return (
    <section id="pipeline" className="relative isolate overflow-hidden py-32 sm:py-40">
      <div
        aria-hidden
      ...
      <div className="container relative">
            ...
            >
              ...
              <div className="space-y-2">
                {stage.deals.map((d) => (
                  <div
                    key={d.name}
                    className="group rounded-xl border border-border/60 bg-background/60 p-3 transition-all duration-300 hover:border-ember/40 hover:bg-background/80"
                  >
        ...
        <div className="mt-10 grid gap-3 md:grid-cols-3">
          {[
            ...
            <div
              key={m.l}
              className="flex items-center justify-between rounded-xl border border-border/70 bg-card/40 p-5"
            >
              <div>
              ...
              <span
                className={`flex h-9 w-9 items-center justify-center rounded-full ${
                  m.up
                    ? "bg-[hsl(140_70%_55%)]/15 text-[hsl(140_70%_60%)]"
